...
function usage(){
    echo >&2
    echo "Usage: $0 image_name project region" >&2
    ...
    echo >&2
    echo "base is optional; default value is gcr.io (Google Container Registry) if it" >&2
    echo "is not provided. When you want to use Google Artifact Registry" >&2
    echo "set value docker.pkg.dev." >&2
    echo >&2
}
